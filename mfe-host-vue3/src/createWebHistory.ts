// This is a custom Jfrog implementation of the createWebHistory function from Vue Router.
// More information can be found here:
// https://github.com/single-spa/single-spa-vue/issues/118
...
function useHistoryListeners(
    ...
    const popStateHandler: any = ({
                                      state,
                                      singleSpa,
                                  }: {
        state: StateEntry | null,
        singleSpa: string | undefined,
        singleSpaTrigger: string | undefined
    }) => {
        ...
        if (state) {
            ...
            // jf fix for vue-router3 navigation issue
            // historyState.value = {
            //     ...state,
            //     current: to
            // }
        ...
        // jf fix for double route guards
        // if (singleSpa) {
        //     return
        // }
 ...
 * @param base -
 */
export function createWebHistorySingleSpaSupport(base?: string): RouterHistory {
